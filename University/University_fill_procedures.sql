...
--
delimiter //
CREATE PROCEDURE fill_1000()
BEGIN

CALL fill_faculty(10); -- 10
CALL fill_student(10); -- 10
CALL fill_teacher(10); -- 10
CALL fill_consulation_hours(100); -- 1000
CALL fill_course(1); -- 100
CALL fill_attendance(1); -- 1000
CALL fill_mark(1); -- 1000
CALL fill_course(9); -- 100 + 900
CALL fill_faculty(990); -- 10 + 990
CALL fill_student(990); -- 10 + 990
CALL fill_teacher(990); -- 10 + 990
...
CALL fill_course(1);
CALL fill_attendance(1);
CALL fill_mark(1);

DROP PROCEDURE fill_person;
DROP PROCEDURE fill_teacher;
DROP PROCEDURE fill_student;
DROP PROCEDURE fill_consulation_hours;
DROP PROCEDURE fill_course;
DROP PROCEDURE fill_attendance;
DROP PROCEDURE fill_mark;
